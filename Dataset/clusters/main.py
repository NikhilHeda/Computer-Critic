...
for filename in glob.glob('*.json'):
    with open(filename) as file:
        ...
        rate = calcRating(neg_review_avg, neu_review_avg, pos_review_avg, neg_summary_avg, neu_summary_avg,
                          pos_summary_avg)
        if prod_count == 1:
            print("[{ \"ProductID\" : ", data['asin'], " , \"neg_review_avg\" : ", neg_review_avg,
                  " , \"neu_review_avg\" : ", neu_review_avg, " , \"pos_review_avg\" : ", pos_review_avg,
                  " , \"neg_summary_avg\" : ", neg_summary_avg, " , \"neu_summary_avg\" : ", neu_summary_avg,
                  " , \"pos_summary_avg\" : ", pos_summary_avg, " , \"rating\" : ", rate, " }", end="")
        else:
            print(", { \"ProductID\" : ", data['asin'], " , \"neg_review_avg\" : ", neg_review_avg,
                  " , \"neu_review_avg\" : ", neu_review_avg, " , \"pos_review_avg\" : ", pos_review_avg,
                  " , \"neg_summary_avg\" : ", neg_summary_avg, " , \"neu_summary_avg\" : ", neu_summary_avg,
