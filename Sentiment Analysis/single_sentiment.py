...
with open("small.json") as file:  
         ...
         for line in file:
              ...
              if line_count == 1:
                 print("[{ \"ProductID\" : ",data['asin']," , \"neg_review\" : ",neg_review," , \"neu_review\" : ",neu_review," , \"pos_review\" : ",pos_review," , \"neg_summary\" : ",neg_summary," , \"neu_summary\" : ",neu_summary," , \"pos_summary\" : ",pos_summary," , \"rating\" : ",rate," }",end="")
              else:
                 print(", { \"ProductID\" : ",data['asin']," , \"neg_review\" : ",neg_review," , \"neu_review\" : ",neu_review," , \"pos_review\" : ",pos_review," , \"neg_summary\" : ",neg_summary," , \"neu_summary\" : ",neu_summary," , \"pos_summary\" : ",pos_summary," , \"rating\" : ",rate," }",end="")
